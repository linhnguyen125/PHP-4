                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-outlined date-picker" name="date_of_birth" id="outlined-date-picker" value="{{old('date_of_birth')}}">
