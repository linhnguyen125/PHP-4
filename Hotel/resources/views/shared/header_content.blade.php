<section class="frontpage-slider">
    <div class="owl-slider owl-slider-header owl-slider-fullscreen">
        ...
        <div class="item" style="background-image:url({{asset('assets/client/assets/images/slide-3.jpg')}})">
        ...
        <div class="item" style="background-image:url({{asset('assets/client/assets/images/slide-1.jpg')}})">
            <div class="box text-center">
                <div class="container">
                    <h2 class="title animated h1" data-animation="fadeInDown">
                        The privacy and <br />
        ...
        <div class="item" style="background-image:url({{asset('assets/client/assets/images/slide-2.jpg')}})">
            <div class="box text-center">
                <div class="container">
                    <div class="rating animated" data-animation="fadeInDown">
                        <i class="fa fa-star"></i>
