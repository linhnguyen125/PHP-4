<section class="image-blocks image-blocks-header">
    ...
    <div class="container">
        ...
        <div class="blocks blocks-left">
            ...
            <div class="image" style="background-image:url({{asset('assets/client/assets/images/apartment-1.jpg')}})">
                <img src="{{asset('assets/client/assets/images/apartment-1.jpg')}}" alt="" />
            </div>
        </div>
        ...
        <div class="blocks blocks-right">
            ...
            <div class="image" style="background-image:url({{asset('assets/client/assets/images/apartment-2.jpg')}})">
                <img src="{{asset('assets/client/assets/images/apartment-2.jpg')}}" alt="" />
            </div>
        </div>
